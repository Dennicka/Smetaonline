    ...
    public function build(array $creditNote, array $snapshot, array $context = []): array
    {
        ...
        return [
            'document' => [
                ...
                'currency' => $currency,
                'tax_mode' => $this->firstScalarString([$creditNote['tax_mode'] ?? null, $header['tax_mode'] ?? null]),
                'reverse_charge_note' => $this->firstScalarString([$creditNote['reverse_charge_note'] ?? null, $header['reverse_charge_note'] ?? null]),
            ...
            'context' => [
                ...
                'client_company_name' => $this->firstScalarString([$creditNote['client_company_name'] ?? null, $client['company_name'] ?? null]),
                'client_org_number' => $this->firstScalarString([$creditNote['client_org_number'] ?? null, $client['org_number'] ?? null]),
                'client_vat_number' => $this->firstScalarString([$creditNote['client_vat_number'] ?? null, $client['vat_number'] ?? null]),
