...
final class CreditNoteFromInvoiceService
{
    ...
    public function buildPayload(array $invoiceRow, ?DateTimeImmutable $issuedAtUtc = null): array
    {
        ...
        return [
            ...
            'tax_mode' => TaxMode::normalize($invoiceRow['tax_mode'] ?? null),
            'reverse_charge_note' => (string) ($invoiceRow['reverse_charge_note'] ?? ''),
            'client_company_name' => (string) ($invoiceRow['client_company_name'] ?? ''),
            'client_org_number' => (string) ($invoiceRow['client_org_number'] ?? ''),
            'client_vat_number' => (string) ($invoiceRow['client_vat_number'] ?? ''),
