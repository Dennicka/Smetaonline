...
final class InvoiceFromOffertService
{
    ...
    public function buildPayload(array $offertRow, array $offertSnapshot, ?DateTimeImmutable $issuedAtUtc = null): array
    {
        ...
        return [
            ...
            'tax_mode' => TaxMode::normalize($offertRow['tax_mode'] ?? null),
            'reverse_charge_note' => (string) ($offertRow['reverse_charge_note'] ?? ''),
            'client_company_name' => (string) ($offertRow['client_company_name'] ?? ''),
            'client_org_number' => (string) ($offertRow['client_org_number'] ?? ''),
            'client_vat_number' => (string) ($offertRow['client_vat_number'] ?? ''),
