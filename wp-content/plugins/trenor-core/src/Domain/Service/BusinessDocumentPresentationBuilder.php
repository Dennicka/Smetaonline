...
final class BusinessDocumentPresentationBuilder
{
    ...
    public function build(string $documentType, array $document, array $snapshot = [], array $context = []): array
    {
        ...
        $specific = [
            ...
            ['label' => 'Outstanding amount', 'value' => $this->string($context['payment_summary']['outstanding_minor'] ?? ($metadata['invoice_outstanding_minor'] ?? null))],
            ['label' => 'Paid amount', 'value' => $this->string($context['payment_summary']['paid_total_minor'] ?? null)],
            ['label' => 'Computed invoice status', 'value' => $this->string($context['payment_summary']['computed_status'] ?? null)],
            ['label' => 'Offert note', 'value' => $this->string($context['offert_note'] ?? null)],
            ['label' => 'Invoice note', 'value' => $this->string($context['invoice_note'] ?? null)],
            ['label' => 'Offert footer text', 'value' => $this->string($context['offert_footer_text'] ?? null)],
            ['label' => 'Invoice footer text', 'value' => $this->string($context['invoice_footer_text'] ?? null)],
            ['label' => 'Credit note footer text', 'value' => $this->string($context['credit_note_footer_text'] ?? null)],
