...
final class AttachmentRepository extends BaseRepository
{
    ...
    public function create(array $data): ?int
    {
        ...
        $inserted = $wpdb->insert(
            $this->table(),
            [
                'parent_entity_type' => sanitize_key((string) ($data['parent_entity_type'] ?? 'project')),
    ...
    public function forParent(string $parentEntityType, int $parentEntityId): array
    {
        global $wpdb;
